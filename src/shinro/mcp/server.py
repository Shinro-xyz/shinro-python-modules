...
from shinro.factories.registry import _CONTROLLER_REGISTRY, _ESTIMATOR_REGISTRY, _TRAJECTORY_REGISTRY
from shinro.factories.trajectory_factory import TrajectoryFactory
from shinro.utils.array_backend import NumpyBackend, TorchBackend
...
def main() -> None:
    """Run the MCP server over stdio (entry point for ``shinro-mcp``)."""
